...
export function Sidebar() {
  ...
  return (
    <aside
      className="flex h-full w-[248px] shrink-0 flex-col border-r border-[var(--color-border)]"
      style={{ background: branding.sidebarColor }}
    >
      ...
      <div className="border-t border-white/10 px-2 py-2">
        ...
        >
          <Settings className="h-4 w-4 shrink-0" strokeWidth={2.25} />
          Settings
        </NavLink>
      </div>
